...
'''parser.add_argument('--annotation', default='F:/DATA/JIGSAWS/annotation.txt', type=str, help='annotation path')
parser.add_argument('--video', default='F:/DATA/JIGSAWS/Videos/', type=str, help='Video path')
parser.add_argument('--image', default='F:/DATA/JIGSAWS/Images/', type=str, help='Video to images save path')'''
...
class resnet_lstm(torch.nn.Module):
    def __init__(self):
        ...
        self.fc = nn.Linear(128, 7)   # 将原来的fc层改成fclass层,原来的fc层：self.fc = nn.Linear(512 * block.expansion, num_classes)。####注意修改类别
    ...
    def forward(self, x):  # forward方法中主要是定义数据在层之间的流动顺序，也就是层的连接顺序
